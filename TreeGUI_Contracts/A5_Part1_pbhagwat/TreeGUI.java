	...
	public TreeGUI() {
		...
		insertButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if (is_new_tree) {
					...
					if(flag== true && tree_kind.getSelectedIndex() != 0)
					{
						tm.set_state(tree);
					}
		...
		deleteButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				//Code to delete the root node
				if(tree.value== n && tree.left==null && tree.right==null && tree.get_count()==1)						
				{						
				...
				{ 								
						JOptionPane.showMessageDialog(null, "Unable to delete. Not in tree or tree has only one value " + n);	
				}
		...
		undoButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if ((tm.get_state() == null)) {
					JOptionPane.showMessageDialog(null, "Tree is empty. Can't perform Undo Operation...");
					return;
				}	
				tree=tm.get_state();
				if(tree!=null) {
